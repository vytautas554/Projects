...
function deleteSG($nr){
    $manoSQL = "DELETE FROM kombinuotos_sg WHERE id = '$nr' LIMIT 1";
...
function createSG($dydis, $spalva, $kaina, $aprasymas){
    $manoSQL = "INSERT INTO kombinuotos_sg VALUES(NULL, '$dydis', '$spalva', '$kaina', '$aprasymas')";
...
function editSG($dydis, $spalva, $kaina, $aprasymas){
    $manoSQL = "UPDATE kombinuotos_sg SET
                                dydis = '$dydis',
                                spalva = '$spalva',
                                kaina = '$kaina',
                                aprasymas = '$aprasymas'
...
/*
    ...
    */
function getSG($nr){
    $manoSQL = "SELECT * FROM kombinuotos_sg WHERE id = '$nr'";
...
//SGS- sapnu gaudykles!!!!!!!!!
function getSGS(){
    $manoSQL = "SELECT * FROM kombinuotos_sg";
    //$rezultataiOBJ - Mysql objektas
    $rezultataiOBJ = mysqli_query(getPrisijungimas(), $manoSQL);
